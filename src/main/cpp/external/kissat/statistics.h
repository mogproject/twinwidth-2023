...
METRIC ( literals_minimize_shrunken, 1, PCNT_LITS_SHRUNKEN, "%", "shrunken") \
...
STATISTIC( vivify_implied, 2, PCNT_VIVIFIED, "%", "vivified") \
...
STATISTIC( vivify_strengthened, 1, PCNT_STR, "%", "strengthened") \
STATISTIC( vivify_subsumed, 1, PCNT_SUB, "%", "subsumed") \
