...
#endif
  CREALLOC_VARIABLE_INDEXED (assigned, assigned_);
  CREALLOC_VARIABLE_INDEXED (flags, flags_);
  NREALLOC_VARIABLE_INDEXED (links, links_);

  CREALLOC_LITERAL_INDEXED (mark, marks);
  CREALLOC_LITERAL_INDEXED (value, values);
  CREALLOC_LITERAL_INDEXED (watches, watches_);
...
kissat_decrease_size (kissat * solver)
{
  ...
  NREALLOC_VARIABLE_INDEXED (assigned, assigned_);
  NREALLOC_VARIABLE_INDEXED (flags, flags_);
  NREALLOC_VARIABLE_INDEXED (links, links_);

  NREALLOC_LITERAL_INDEXED (mark, marks);
  NREALLOC_LITERAL_INDEXED (value, values);
  NREALLOC_LITERAL_INDEXED (watches, watches_);
